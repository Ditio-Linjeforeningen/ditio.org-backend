...
public class UserDB extends OidcUserService {
    ...
    public OidcUser loadUser(OidcUserRequest userRequest) {
        // 1. Hent standardbrugeren fra Feide
